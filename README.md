<div align="center">
<img src="./public/images/volume.svg" alt="logo" height="80">
...
`cz-admin` 是一个中后台前端解决方案，基于 `vue3.x` 和 `and-design-vue` 实现。 使用最新的前端技术栈，提供丰富的组件，并持续性提供丰富的业务模板快速搭建企业级中后台前端项目。

## 特性
+ ⚡️ 新版极速响应的 [Vite 4](https://cn.vitejs.dev) 前端构建工具。
