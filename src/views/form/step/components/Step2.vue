<template>
  <div>
    ...
    >
      ...
      <a-divider />
      <a-form-item label="支付密码" name="paymentPassword">
        <a-input v-model:value="formData.paymentPassword" type="password" :style="{ width: '80%' }" />
      </a-form-item>
      <a-form-item :wrapper-col="{ span: 19, offset: 5 }">
        <a-space>
          <a-button type="primary" :loading="loading" @click="handleNext">提交</a-button>
