<template>
  <a-card>
    <div class="align-center mb-8-3">
      <a-avatar class="mb-4-5" src="http://cdn.xuanyunet.com/images/avatar.jpg" :size="104"></a-avatar>
    ...
    <div class="display-flex flex-wrap-wrap" :style="{ gap: '8px' }">
      <a-tag v-for="item in tagList" :key="item">
        {{ item }}
      </a-tag>
    </div>
    <a-divider></a-divider>
