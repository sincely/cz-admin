<template>
  <a-page-header :ghost="false" main title="单号：234231029431">
    <template #extra>
      <a-space>
    ...
    <a-row align="middle" type="flex">
      ...
      <a-col class="align-right pr-8-5">
        <a-space :size="40">
          <a-statistic title="状态" value="待审批"></a-statistic>

          <a-statistic title="订单金额" value="¥568.08"></a-statistic>
        </a-space>
      </a-col>
    </a-row>
    <template #footer>
  ...
  <a-card title="流程进度">
    <a-steps :current="1" class="mt-8-2" progress-dot>
      <a-step title="创建项目">
  ...
  <a-card class="mt-8-2" title="用户近半年来电记录">
    <a-empty></a-empty>
  </a-card>
