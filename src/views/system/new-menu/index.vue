<template>
  <a-row :gutter="8" :wrap="false">
    <a-col flex="0 0 280px">
      <menus v-model:value="searchFormData.menu" @change="onMenuChange"></menus>
    </a-col>
    <a-col flex="1.2">
      <a-card title="菜单信息" :style="cpStyle" :body-style="cpBodyStyle">
      ...
      <a-card title="权限按钮" :style="cpStyle" :body-style="cpBodyStyle">
        <x-scrollbar class="pa-8-2">
          <x-form-table v-model="authList" :row-tpl="{ name: '', alias: '' }" bordered>
            ...
            <a-table-column data-index="alias" title="标识">
              <template #default="{ record }">
