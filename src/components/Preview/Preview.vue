  ...
  >
    <div class="x-preview__content" :style="cpContentStyle">
      ...
      <template v-if="cpFileType === 'audio'">
        <audio controls :src="cpUrl"></audio>
      </template>
    </div>
    ...
    <div class="x-preview__top">
      ...
      <div class="x-preview__action">
        <template v-if="cpFileType === 'image'">
          ...
          <!-- 放大 -->
          <div class="x-preview__action-btn" @click="handleZoomIn">
            <zoom-in-outlined />
          </div>
          <!-- 左旋转 -->
          <div class="x-preview__action-btn" @click="handleRotateLeft">
            <rotate-left-outlined />
          </div>
          <!-- 右旋转 -->
          <div class="x-preview__action-btn" @click="handleRotateRight">
            <rotate-right-outlined />
          </div>
        </template>
        <!-- 关闭 -->
        <div class="x-preview__action-btn" @click="handleClose">
