...
<template>
  <x-filter :model="formData">
    <x-filter-item label="品牌">
      <x-tag-select v-model="formData.brand" :options="brandOptions"></x-tag-select>
    </x-filter-item>
    <x-filter-item label="分类">
      <x-tag-select v-model="formData.classification" :options="classificationOptions"></x-tag-select>
    </x-filter-item>
    <x-filter-item label="机身内存">
      <x-tag-select v-model="formData.memory" :options="memoryOptions"></x-tag-select>
    </x-filter-item>
    <x-filter-item label="CPU型号">
      <x-tag-select v-model="formData.cpu" :options="cpuOptions" multiple></x-tag-select>
    </x-filter-item>
  </x-filter>
</template>
