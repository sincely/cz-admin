<template>
  <a-card class="x-demo-box">
    ...
    <div class="x-demo-box__meta">
      ...
      <div v-if="component.description" class="x-demo-box__description" v-html="component.description"></div>
      <div class="x-demo-box__actions">
        <a-tooltip :title="copied ? '复制成功' : '复制代码'">
          <span class="x-demo-box__action" @click="handleCopy()">
            <check-outlined v-if="copied" class="color-success"></check-outlined>
            <copy-outlined v-else></copy-outlined>
          </span>
        </a-tooltip>
        <a-tooltip :title="open ? '隐藏代码' : '显示代码'">
          <span class="x-demo-box__action" @click="open = !open">
    ...
    <div v-show="open">
      ...
      <div class="x-demo-box__toggle" @click="open = !open">
