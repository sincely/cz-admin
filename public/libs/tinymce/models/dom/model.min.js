...
!(function () {
    ...
    const Zr = (e, t, o, n) => {
        ...
        ts = Xr(),
        os = (e, t) =>
            ((e, t, o) => (o.length > 0 ? ((e, t, o, n) => n(e, t, o[0], o.slice(1)))(e, t, o, Zr) : C.none()))(
                ts,
                (t, o) => e(o),
                t
            ),
        ...
        ls = (e, t, o) =>
            wt(e, t).bind((t) => wt(e, o).bind((e) => os(ns, [t, e]).map((o) => ({ first: t, last: e, table: o })))),
        as = (e, t, o, n, r) =>
        ...
        us = (e, t, o) =>
            t.length <= 1
                ? C.none()
                : is(e, o.firstSelectedSelector, o.lastSelectedSelector).map((e) => ({ bounds: e, cells: t })),
        fs = {
        ...
        Cl = (e, t, o, n, r) => {
            ;((e, t, o, n) => {
                ...
                if (t > 0 && t < r.length) {
                    const e = ((e, t) =>
                        L(e, (e, o) => (O(e, (e) => t(e.element, o.element)) ? e : e.concat([o])), []))(
                        r[t - 1].cells,
                        o
                    )
                    N(e, (e) => {
        ...
        jl = (e) =>
            L(e, (e, t) => (O(e, (e) => e.column === t.column) ? e : e.concat([t])), []).sort(
                        ...
                        .bind((o) => {
                            const n = Le(o)
                                .map(
                                    (e) =>
                                        !!Yl(e) ||
                                        (!!((e, t) => D(['br', 'img', 'hr', 'input'], e.property().name(t)))(Kl, e) &&
                                            'img' !== ne(e))
                                )
                                .getOr(!1)
                            return Ne(o).map((r) => {
        ...
        oa = (e) =>
            L(e, (e, t) => (O(e, (e) => e.row === t.row) ? e : e.concat([t])), []).sort((e, t) => e.row - t.row),
        na = (e, t) => (o, n, r, s, l) => {
            const a = oa(n),
                c = E(a, (e) => e.row),
                i = ((e, t, o, n, r, s, l) => {
                    ...
                    const f = [...a, ...u],
                        g = ((e, t) => (P(t, h) && Ms(e.cells) ? x : (e, o, n) => !('th' === ne(e.element) && t[n])))(
                            i,
                            d
                        ),
                        p = (
        ...
        wa = rl(
            (e, t, o, n) => {
                const r = t[0].row,
                    s = oa(t),
                    l = A(s, (e, t) => ({ grid: Sl(e.grid, r, t.row + e.delta, o, n.getOrInit), delta: e.delta + 1 }), {
                        grid: e,
                        delta: 0,
                    }).grid
        ...
        va = rl(
            (e, t, o, n) => {
                const r = t.details,
                    ...
                    a = A(
                        s,
                        (e, t) => ({ grid: Tl(e.grid, l, t.column + e.delta, o, n.getOrInit), delta: e.delta + 1 }),
                        { grid: e, delta: 0 }
                    ).grid
        ...
        za = rl(
            ...
            (e, t) =>
                $t(t.element).bind((o) =>
                    ol(e, o).map((e) => ({ ...e, generators: t.generators, clipboard: t.clipboard }))
                ),
            ca,
            f,
            Vl
                    ...
                    .map(
                        (t) => (
                            oc(e)
                                ...
                                : nc(e)
                                  ? kc(t)
                                  : (tc(e) || ((e) => r(e) && -1 !== e.indexOf('%'))(l.width)) && Dc(t),
                            jr(t),
                            be(t, 'data-mce-id'),
                            ((e, t) => {
                                N(dt(t, 'tr'), (t) => {
                    ...
                    o().each((o) => {
                        ...
                        l((o, r) => {
                            const s = zr(xe.fromDom(e.getDoc())),
                                l = ((e, t, o, n) => ({ selection: ms(e), clipboard: o, generators: n }))(
                                    bs(e),
                                    0,
                                    n,
                                    s
    ...
    const ai = (e, t, o, n) => ({ start: e, soffset: t, finish: o, foffset: n }),
        ...
        di = (e, t, o, n, r) =>
            Re(o, n)
                ...
                : rs(o, n, t).bind((t) => {
                      ...
                      return n.length > 1
                          ? (r(e, n, t.start, t.finish), C.some(Jc(C.some(mi(o, 0, o, br(o))), !0)))
                          : C.none()
                  }),
        ...
        wi = (e, t, o, n, r = pi) =>
            W(r, (e) => e.current === o).bind((o) =>
                o.current(e, t, n, o.next).orThunk(() => o.fallback.bind((o) => wi(e, t, o, n)))
            ),
        bi = (e, t, o, n, r, s) =>
            wi(e, t, n, r).bind((t) =>
                s(t.item) ? C.none() : o(t.item) ? C.some(t.item) : bi(e, t.item, o, t.mode, r, s)
            ),
            ...
            bt(n, 'td,th', t).bind((n) =>
                bt(n, 'table', t).bind((s) =>
                    ((e, t) => ft(e, (e) => Ne(e).exists((e) => Re(e, t)), void 0).isSome())(r, s)
                        ? ((e, t, o) => Vi(e, t, o).bind((n) => $i(e, t, n.element, n.offset, o, 20).map(e.fromSitus)))(
                              e,
                              t,
                              o
                          ).bind((e) => bt(e.finish, 'td,th', t).map((t) => ({ start: n, finish: t, range: e })))
                        : C.none()
                )
            ),
        Ji = (e, t, o, n, r, s) =>
            ...
            bt(e, 'tr', t).bind((e) =>
                bt(e, 'table', t).bind((o) => {
                    ...
                    return Re(e, n[n.length - 1])
                        ? ((e, t, o) => xi(Ci, e, (e) => xr(e).isSome(), o))(o, 0, t).map((e) =>
                              Jc(C.some(mi(e, 0, e, 0)), !0)
                          )
                        : C.none()
                })
            ),
                ...
                ((e, t, o) =>
                    ((e, t, o) => {
                        ...
                        return gm(n, t, o).map((e) =>
                            ai(xe.fromDom(e.startContainer), e.startOffset, xe.fromDom(e.endContainer), e.endOffset)
                        )
                                        ...
                                        g = ss(t, n.selectedSelector).fold(
                                            ...
                                            (e) => {
                                                const o = (o) => () => {
                                                    ...
                                                    return s.fold(
                                                        () =>
                                                            ls(t, n.firstSelectedSelector, n.lastSelectedSelector).map(
                                                                (e) => {
                                                                    const o =
                                                                        cm(u) || m.isForward(u) ? Yc.after : Yc.before
                                                                    return (
