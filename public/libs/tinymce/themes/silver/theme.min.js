...
!(function () {
    ...
    const an = (e, t, o) => (e.stype === sn.Error ? t(e.serror) : o(e.svalue)),
        ...
        Cn = (e) => ({
            extract: (t, o) =>
                ((e, t) => (e.stype === sn.Error ? t(e.serror) : e))(e(o), (e) => ((e, t) => kn(e, x(t)))(t, e)),
            toString: x('val'),
        }),
        On = Cn(dn),
            ...
            const s = (e) => r.extract(t.concat([n]), e),
                a = (e) =>
                    e.fold(
                        () => dn(A.none()),
                        (e) =>
                            ((e, t) => (e.stype === sn.Value ? { stype: sn.Value, svalue: t(e.svalue) } : e))(
                                r.extract(t.concat([n]), e),
                                A.some
                            )
                    )
            switch (e.tag) {
        ...
        Mn = (e) => {
            ...
            return {
                extract: (e, n) => {
                    ...
                    return 0 === s.length
                        ? t.extract(e, n)
                        : ((e, t) => kn(e, () => 'There are unsupported fields: [' + t.join(', ') + '] specified'))(
                              e,
                              s
                          )
                },
        ...
        qn = (e, t, o) => {
            return (
                (n = ((e, t, o) =>
                    ((e, t) => (e.stype === sn.Error ? { stype: sn.Error, serror: t(e.serror) } : e))(
                        t.extract([e], o),
                        (e) => ({ input: o, errors: e })
                    ))(e, t, o)),
        ...
        tr = (e) =>
            Gn((t) =>
                R(e, t) ? rn.value(t) : rn.error(`Unsupported value: "${t}", choose one of "${e.join(', ')}".`)
            ),
    ...
    const _i = x(Dn(Oi())),
        ...
        ul = (e, t, o) =>
            zi(((e, t) => e.x - t.width)(e, t), nl(e, t), o.west(), qi(), 'west', Yi(e, { right: 1 }), Ji),
        ...
        ac = (e, t, o, n, r, a) => {
            ...
            if (i || ((e, t) => Ga(e, t.classes))(e, n)) {
                ...
                ;((e, t) => {
                    ...
                    return he(
                        t,
                        (t, n) => !((e, t, o = S) => Se(e, t, o).getOr(e.isNone() && t.isNone()))(e[n].map(o), t.map(o))
                    ).isSome()
                })(o, c) &&
                    (Ft(e, c),
                    i &&
    ...
    var lu = [
        ...
        uu = [
            xr('store', { mode: 'memory' }, Jn('mode', { memory: du, manual: cu, dataset: lu })),
            Di('onSetValue'),
            yr('resetOnDom', !1),
        ]
    const mu = Ol({
    ...
    const vm = [or('find')],
        ...
        Am = (e, t) =>
            Sm(e, t) ? ((e) => Tt(e.element, 'disabled'))(e) : ((e) => 'true' === Ot(e.element, 'aria-disabled'))(e)
    ...
    var hg = pg(er('cyclic', T)),
        fg = pg(er('cyclic', E))
    const bg = (e, t, o) =>
            fm(o) && ng(Xm)(t.event) ? A.none() : ((e, t, o) => (Ns(e, o, us()), A.some(!0)))(e, 0, o),
        vg = (e, t) => A.some(!0),
    ...
    const Kg = (e, t, o, n, r) => {
            const s = (e, t, o) =>
                r(e, t, n, 0, o.length - 1, o[t], (t) => {
                    return (
                        (n = o[t]), 'button' === Ue(n) && 'disabled' === Ot(n, 'disabled') ? s(e, t, o) : A.from(o[t])
                    )
                    var n
                })
    ...
    const ch = () => {
        ...
        wh = [
            or('dom'),
            or('components'),
            Ri('builder', (e) => ({ dom: e.dom, components: e.components, events: Hs([Xs(ms())]) })),
        ],
        Sh = x('item-widget'),
        kh = x([
            Lu({
                name: 'widget',
                overrides: (e) => ({
                    behaviours: kl([mu.config({ store: { mode: 'manual', getValue: (t) => e.data, setValue: b } })]),
                }),
            }),
        ]),
        Ch = [
            ...
            Ri('builder', (e) => {
                const t = Zu(Sh(), e, kh()),
                    ...
                    r = (t, o) =>
                        fm(o.event.target) ? A.none() : e.autofocus ? (o.setSource(t.element), A.none()) : A.none()
                return {
                    dom: e.dom,
                    components: o,
                ...
                const g = (t, o, s = m.HighlightSubmenu) => {
                    ...
                    y = {
                        ...
                        repositionMenus: (t) => {
                            ...
                            o.fold(
                                () => {
                                    ;((e) => A.from(e.components()[0]).filter((e) => 'menu' === Ot(e.element, 'role')))(
                                        t
                                    ).each((o) => {
        ...
        Kb = (e, t, o, n, r) => {
                    ...
                    components: [
                        {
                            ...
                            components: [
                                Ah.parts.items({
                                    preprocess:
                                        'auto' !== e ? Ub({ tag: 'div', classes: ['tox-swatches__row'] }, e) : w,
                                }),
                            ],
                        },
                    ],
            ...
            if ('listpreview' === r.menuType && 'auto' !== n) {
                const t = ((e) => ({
                    ...
                    components: [
                        Ah.parts.items({ preprocess: Ub({ tag: 'div', classes: ['tox-collection__group'] }, e) }),
                    ],
                }))(n)
                return { value: e, dom: t.dom, components: t.components, items: o }
            }
    ...
    const qv = Dn([Yb, mv, dr('items', jv), iv, wv].concat($v)),
        ...
        Jv = [
            fr('select'),
            Tr('initData', {}, [Cr('allowCustomColors', !0), Sr('storageKey', 'default'), br('colors', Nn())]),
        ].concat(Kv),
            ...
            return {
                ...
                itemBehaviours: kl(
                    [
                        ...
                        Fm.config({ disabled: s, disableClass: 'tox-collection__item--state-disabled' })),
                        by(),
                        Xp.config({}),
            ...
            'color' === e.presets
                ...
                : ((e, t, o, n) => {
                      const r = { tag: 'div', classes: [fb] },
                          s = o
                              ? e.iconContent.map((e) => Zh(e, r, t.icons, n)).orThunk(() => A.some({ dom: r }))
                              : A.none(),
                          a = e.checkMark,
    ...
    const mx = {},
        ...
        kx = (e) => {
            ...
            for (let o = 0; o < e.length; o += 2)
                t.push({ text: e[o + 1], value: '#' + vx(e[o]).value, icon: 'checkmark', type: 'choiceitem' })
            return t
        },
        ...
        _x = (e, t) => {
            const o = ((e, t) =>
                t === yx
                    ? Cx('color_cols_foreground')(e)
                    : t === xx
                      ? Cx('color_cols_background')(e)
                      : Cx('color_cols')(e))(e, t)
            return o > 0 ? o : 5
        },
        Tx = Cx('custom_colors'),
        ...
        Ix = (e, t, o) =>
            e.concat(
                ((e) => H(gx(e).state(), (e) => ({ type: 'choiceitem', text: e, icon: 'checkmark', value: e })))(
                    t
                ).concat(Bx(o))
            ),
        Rx = (e, t, o) => (n) => {
            ...
            init: () => {
                ...
                return _a({
                    ...
                    getExisting: (e, o, n) =>
                        t(o, n).orThunk(
                            () => (
                                be(o.others, n).getOrDie('No information found for coupled component: ' + n), A.none()
                            )
                        ),
                    getOrCreate: (o, n, r) =>
                        t(n, r).getOrThunk(() => {
    ...
    const ew = Ol({ fields: Zx, name: 'coupling', apis: Jx, state: Qx }),
        ...
        yw = x([
            Pu({ schema: [Ei(), yr('fakeFocus', !1)], name: 'menu', defaults: (e) => ({ onExecute: e.onExecute }) }),
            lw(),
        ]),
        xw = hm({
            name: 'Dropdown',
            ...
            factory: (e, t, o, n) => {
                ...
                return {
                    ...
                    behaviours: hu(e.dropdownBehaviours, [
                        ...
                        ew.config({
                            others: { sandbox: (t) => hw(e, t, { onOpen: () => lh.on(t), onClose: () => lh.off(t) }) },
                        }),
                        Hp.config({
                            mode: 'special',
                            onSpace: i,
    ...
    const Ow = (e, t, o, n, r) => {
                              ...
                              ;((n = Ve(e.getBody())), pi(n, lb)).each((n) => {
                                  ...
                                  Hh.showMenuAt(
                                      ...
                                      ((e, t, o, n) => {
                                          ...
                                          Kb('autocompleter-value', !0, o, s, { menuType: 'normal' }),
                                          s,
                                          Cw.ContentFocus,
                                          'normal'
                                      )
        ...
        Gw = (e) => {
            const t = (t) => rt(e.element).fold(E, (e) => Ze(t, e)),
                ...
                r = Vw(e.element, {
                    triggerEvent: (e, t) =>
                        Si(e, t.target, (o) => ((e, t, o, n) => Uw(e, t, o, o.target, n))(n, e, t, o)),
                }),
                s = {
                    debugInfo: x('real'),
                    triggerEvent: (e, t, o) => {
                ...
                p = (e) =>
                    o
                        .getById(e)
                        .fold(
                            () => rn.error(new Error('Could not find component with uid: "' + e + '" in system.')),
                            rn.value
                        ),
                h = (e) => {
    ...
    var Kw = Object.freeze({
            __proto__: null,
            exhibit: (e, t) => Ea({ attributes: Dr([{ key: t.tabAttr, value: 'true' }]) }),
        }),
    ...
    const Qw = (e, t, o, n) => {
        ...
        oS = (e, t) =>
            Xw.parts.label({ dom: { tag: 'label', classes: ['tox-label'] }, components: [ti(t.translate(e))] }),
                                ...
                                ;((e) => 'hex' === e.type)(n)
                                    ...
                                    : ((e, t, o) => {
                                          ...
                                          d(t, A.some(n)),
                                              c('red')
                                                  .bind((e) =>
                                                      c('green').bind((t) => c('blue').map((o) => ex(e, t, o, 1)))
                                                  )
                                                  .each((t) => {
                                                      const o = ((e, t) => {
                                                          const o = Xy(t)
    ...
    const DC = la('alloy-fake-before-tabstop'),
                    ...
                    xw.sketch({
                        ...
                        sandboxBehaviours: kl([
                            ...
                            Kp('dropdown-sandbox-events', [
                                ...
                                Us(Rb, (e, t) => {
                                    ;((e, t) => {
                                        ;((e) => $d.getState(e).bind(Wm.getHighlighted).bind(Wm.getHighlighted))(
                                            e
                                        ).each((o) => {
                                            ;((e, t, o, n) => {
                                                const r = { ...n, target: t }
        ...
        aO = x([
            ...
            Lu({
                ...
                overrides: (e) => ({
                    buttonBehaviours: kl([
                        lh.config({ selected: e.locked, toggleClass: e.markers.lockClass, aria: { mode: 'pressed' } }),
                    ]),
                }),
            }),
        ]),
        ...
        vO = (e, t, o, n) => {
            o.setCollapsed(),
                Dt(e.element, gO(t), pO(t, e.element)),
                hO(e, t),
                fO(e, t),
                t.onStartShrink(e),
                t.onShrunk(e)
            ...
            exhibit: (e, t, o) => {
                ...
                return Ea(
                    n
                        ...
                        : { classes: [t.closedClass], styles: Mr(t.dimension.property, '0px') }
                )
            },
            events: (e, t) =>
                Hs([
    ...
    const WO = Ol({ fields: UO, name: 'streaming', active: zO, state: PO }),
        ...
        y_ = {
                                ...
                                Hp.config(
                                    ...
                                    1 === c
                                        ...
                                        : 'auto' === c
                                          ...
                                          : {
                                                mode: 'matrix',
                                                selectors: { row: '.tox-collection__group', cell: `.${gb}` },
                                            })
                                ),
            ...
            button: v_((e, t) =>
                ((e, t) => {
                    ...
                    return (
                        (n = A.none()),
                        (r = Xw.parts.field({ factory: Ph, ...o_(e, A.some(o), t, [TC(''), yC()]) })),
                        Qw(n, r, [], [])
                    )
                    var n, r
                })(e, t.shared.providers)
                    ...
                    const n = H(e.items, (e) => ({ text: t.translate(e.text), value: e.value })),
                        ...
                        a =
                            e.size > 1
                                ? A.none()
                                : A.some(
                                      Zh('chevron-down', { tag: 'div', classes: ['tox-selectfield__icon-js'] }, t.icons)
                                  ),
                    ...
                    return iO.sketch({
                        ...
                        coupledFieldBehaviours: kl([
                            Fm.config({
                                disabled: () => !e.enabled || t.isDisabled(),
                                onDisabled: (e) => {
                                    iO.getField1(e).bind(Xw.getField).each(Fm.disable),
                                        iO.getField2(e).bind(Xw.getField).each(Fm.disable),
                                        iO.getLock(e).each(Fm.disable)
                                },
                                onEnabled: (e) => {
                                    iO.getField1(e).bind(Xw.getField).each(Fm.enable),
                                        iO.getField2(e).bind(Xw.getField).each(Fm.enable),
                                        iO.getLock(e).each(Fm.enable)
                                },
                            }),
                            by(),
                                            ...
                                            cO(e, t.unit)
                                                ...
                                                .map((e) => {
                                                    return (
                                                        (o = e),
                                                        (n = t.unit),
                                                        (e) => cO(e, n).map((e) => ({ value: e * o, unit: n }))
                                                    )
                                                    var o, n
                                                })
                                                .getOr(dO)
                                ...
                                const r = ((e, t, o) => {
                                        ...
                                        return o.getLinkInformation().fold(
                                            ...
                                            (t) => {
                                                ...
                                                return 'file' === e
                                                    ? ((s = [n, p_(r, d_(t)), p_(r, q([m_(t), u_(t), g_(t)]))]),
                                                      j(
                                                          s,
                                                          (e, t) =>
                            ...
                            Ys((r) => {
                                o.getOpt(r).each((o) => {
                                    ;(((e) => ve(e, 'init'))(e)
                                        ...
                                        : AC.load(e.scriptId, e.scriptUrl).then((t) => t(o.element.dom, e.settings))
                                    ).then((e) => {
                                        n.on((t) => {
                                            e.setValue(t)
                                        }),
                        ...
                        components: [
                            ((r = e.header),
                            {
                                ...
                                components: [
                                    {
                                        dom: { tag: 'tr' },
                                        components: H(r, (e) => ({ dom: { tag: 'th', innerHtml: t.translate(e) } })),
                                    },
                                ],
                            }),
                            ((n = e.cells),
            ...
            panel: v_((e, t) =>
                ((e, t) => ({ dom: { tag: 'div', classes: e.classes }, components: H(e.items, t.shared.interpreter) }))(
                    e,
                    t
                )
            ),
        ...
        D_ = (e, t, o) =>
            zi(T_(e, t), A_(e, t), o.insetSouthwest(), Wi(), 'southwest', Yi(e, { right: 0, bottom: 3 }), C_),
        ...
        DT = (e) => ({
            ...
            getLinkInformation: () =>
                ((e) =>
                    Rf(e)
                        ? A.some({ targets: xT(e.getBody()), anchorTop: MT(Nf(e)), anchorBottom: MT(Vf(e)) })
                        : A.none())(e),
        ...
        lE = (e, t, o, n, r = !1) => {
            t.contextual.each((t) => {
                t.lazyContext(e).each((s) => {
                    ...
                    a !== o.isVisible() &&
                        (o.setVisible(a),
                        r && !a ? (Wa(e.element, [t.fadeOutClass]), t.onHide(e)) : (a ? XT : KT)(e, t))
                })
            })
        },
        cE = (e, t, o, n, r) => {
    ...
    const RE = 'container',
        ...
        $E = (e) =>
            ym
                .getCurrent(e)
                .bind((e) =>
                    TO.isGrowing(e) || TO.hasGrown(e)
                        ? ym.getCurrent(e).bind((e) => G(LE.getSlotNames(e), (t) => LE.isShowing(e, t)))
                        : A.none()
                ),
        qE = la('FixSizeEvent'),
        XE = la('AutoSizeEvent')
    var KE = Object.freeze({
            ...
            block: (e, t, o, n) => {
                ...
                const r = t.getRoot(e).getOr(e),
                    s = kl([
                        Hp.config({ mode: 'special', onTab: () => A.some(!0), onShiftTab: () => A.some(!0) }),
                        eh.config({}),
                    ]),
                    a = n(r, s),
    ...
    const JE = Ol({
            ...
            Pu({
                ...
                overrides: (e) => ({
                    toolbarBehaviours: kl([
                        Hp.config({ mode: 'cyclic', onEscape: (t) => (em(t, e, 'button').each(eh.focus), A.none()) }),
                    ]),
                }),
            }),
        ]),
        ...
        pA = (e, t, o, n) => {
            ...
            xd.positionWithinBounds(
                s,
                t,
                { anchor: { type: 'hotspot', hotspot: e, layouts: n, overrides: { maxWidthFunction: cA() } } },
                r
            )
        },
        hA = (e, t, o, n, r) => {
                                            ...
                                            behaviours: kl([
                                                ...
                                                Al.config({
                                                    channels: {
                                                        ...
                                                        ...Qd({
                                                            doReposition: () => {
                                                                $d.getState(ew.getCoupled(e, 'toolbarSandbox')).each(
                                                                    (n) => {
                                                                        pA(e, n, o, t.layouts)
                                                                    }
                                                                )
            ...
            factory: (e, t, o, n) => {
                ...
                return {
                    ...
                    behaviours: hu(e.splitToolbarBehaviours, [
                        ew.config({
                            others: {
                                overflowGroup: () => yA.sketch({ ...n['overflow-group'](), items: [r.asSpec()] }),
                            },
                        }),
                    ]),
                    apis: {
                        ...
                        return {
                            ...
                            dom: {
                                ...
                                classes: [
                                    ...
                                    ...(UA || WA ? ['tox-view--mobile', 'tox-view--scrolling'] : []),
                                ],
                            },
                            behaviours: kl([
                                eh.config({}),
            ...
            pe(t, (t, n) => {
                ...
                return e.slot(
                    ...
                    jA.sketch({
                        ...
                        viewConfig: r,
                        components: [
                            ...(r.buttons.length > 0 ? [jA.parts.header({ buttons: r.buttons, providers: o })] : []),
                            jA.parts.pane({}),
                        ],
                    })
                )
    ...
    const iM = {
        ...
        gM = (e, t) => {
            ...
            return (
                (o = Ve(e.getElement())),
                bt(o).isSome() ? uM(e, t + '/skin.shadowdom.min.css', nf.DOM.styleSheetLoader) : Promise.resolve()
            )
        },
        pM = (e, t) => {
            const o = Xf(t)
    ...
    const OM = (e, t, o) => {
            const n =
                ((r = ((e, t) => (t === CM.SemiColon ? e.replace(/;$/, '').split(';') : e.split(' ')))(
                    e.options.get(t),
                    o
                )),
                H(r, (e) => {
        ...
        NM = (e, t) =>
            A.from(RM.exec(e)).bind((e) => {
                const o = Number(e[1]),
                    n = e[2]
                return ((e, t) => N(t, (t) => N(IM[t], (t) => e === t)))(n, t)
                ...
                (e, t) =>
                    ((e, t) => {
                        const o = (e) => ({
                                ...
                                isActive: () =>
                                    pi(e.element, 'span').exists((t) => e.getSystem().getByDom(t).exists(lh.isOn)),
                                setText: (t) =>
                                    pi(e.element, 'span').each((o) =>
                                        e
                                            .getSystem()
                        ...
                        return XM.sketch({
                            dom: {
                                ...
                                attributes: { 'aria-pressed': !1, ...JM(e.tooltip, t.providers) },
                            },
                            onExecute: (t) => {
                                const n = o(t)
                            ...
                            components: [
                                XM.parts.button(
                                    QM(
                                        ...
                                        e.text,
                                        A.none(),
                                        A.some([lh.config({ toggleClass: 'tox-tbtn--enabled', toggleOnExecute: !1 })]),
                                        t.providers
                                    )
                                ),
                                XM.parts.arrow({
                        ...
                        l = (t, r, s) => {
                            ...
                            o.onAction(m, s),
                                n.each((e) => {
                                    mu.setValue(e, m),
                                        r &&
                                            (p.each((t) => (e.element.dom.selectionStart = t)),
                                            h.each((t) => (e.element.dom.selectionEnd = t)))
                                })
                        },
                        c = (e, t) => l((e, t) => e - t, e, t),
                        d = (e, t) => l((e, t) => e + t, e, t),
                        ...
                        g = (e, o, n, r) => {
                            ...
                            return Ph.sketch({
                                ...
                                buttonBehaviours: kl([
                                    Kp(a, [
                                        Us(Yr(), (t, o) => {
                                            ;(o.event.raw.keyCode !== FM.space() &&
                                                o.event.raw.keyCode !== FM.enter()) ||
                                                e(!1)
                                        }),
                                        Us(es(), i),
                                        Us(Pr(), i),
    ...
    const gD = (e) => (/^[0-9\.]+(|px)$/i.test('' + e) ? A.some(parseInt('' + e, 10)) : A.none()),
        ...
        yD = (e, t, o, n, r) => {
            const { mainUi: s, uiMotherships: a } = o,
                ...
                f = () => h.get() && !e.removed,
                b = (e) =>
                    p ? e.fold(x(0), (e) => (e.components().length > 1 ? Wt(e.components()[1].element) : 0)) : 0,
                v = () => {
                    L(a, (e) => {
                        e.broadcastOn([Xd()], {})
                    })
                ...
                y = (o) => {
                    ...
                    const n = l
                        ...
                        : (() => {
                              if (l) return A.none()
                              if (
                                  Xt(s.outerContainer.element).left + Zt(s.outerContainer.element) >=
                            ...
                            ((o) => {
                                r.on((n) => {
                                    const r = aM.getToolbar(s.outerContainer),
                                        a = b(r),
                                        i = Jo(t),
                                        { top: l, left: c } = ((e, t) => (sb(e) ? $T(t) : A.none()))(
                                            e,
                        ...
                        const r = Er(xD(t, o.isPositionedAtTop())),
                            s = (n) => {
                                ...
                                r.set({ pos: s, bounds: a }),
                                    c && lx(e, n),
                                    o.isVisible() &&
                                        (i !== s ? o.update(vE.reset) : c && (o.updateMode(), o.repositionPopups()))
                            }
    ...
    const SD = 'contexttoolbar-hide',
        ...
        BD = (e, t, o, n) => {
            const r = (t) => (n, r, s, a, i) => ({
                    ...DD(e, a, t, o, i)({ ...n, y: i.y, height: i.height }, r, s, a, i),
                    alwaysFit: !0,
                }),
                s = (e) => (MD(n) ? [r(e)] : [])
            return t
                                    ...
                                    Us(ND, (e, o) => {
                                        ne(t.get()).each((o) => {
                                            t.set(t.get().slice(0, t.get().length - 1)),
                                                Is(e, VD, { contents: ai(o.bar), focus: o.focus })
                                        })
                                    }),
                                ]),
                                Hp.config({
                ...
                x = (t, n) => {
                            ...
                            const r = 'node' === t ? s.anchors.node(n) : s.anchors.cursor(),
                                c = ((e, t, o, n) =>
                                    'line' === t
                                        ...
                                        : { bubble: gc(0, 12, ED, 1 / 12), layouts: BD(e, o, n, t), overrides: AD })(
                                    e,
                                    t,
                                    a(),
                                    {
                    ...
                    Ht(b, 'display'),
                        ...
                        Hh.showWithinBounds(
                            d,
                            f(r),
                            { anchor: h, transition: { classes: [HD], mode: 'placement' } },
                            () => A.some(u())
                        ),
                                        ...
                                        ((e, t, o) =>
                                            e(t)
                                                ...
                                                : Fr(
                                                      ...
                                                      (e) => {
                                                          if (Ge(e)) {
                                                              const { contextToolbars: t, contextForms: n } = FD(
                                                                      e,
                                                                      o.inNodeScope
                                                                  ),
                                                                  r =
        ...
        UD = {
            ...
            getOptions: Kf,
            hash: (e) =>
                ((e, t) => NM(e, ['fixed', 'relative', 'empty']).map(({ value: e, unit: t }) => e + t))(e).getOr(e),
            display: w,
        ...
        sB = (e, t, o) => {
            switch (o) {
                case 'node':
                    return ((e) => ({ type: 'node', node: A.some(Ve(e.selection.getNode())), root: Ve(e.getBody()) }))(
                        e
                    )
                case 'point':
                    return nB(e, t)
                    ...
                    ;((e, t, o, n, r, s, a) => {
                        ...
                        ZC(o, ub.CLOSE_ON_EXECUTE, n, { isHorizontalMenu: !0, search: A.none() }).map((o) => {
                            ...
                            Hh.showMenuWithinBounds(
                                r,
                                { anchor: i },
                                { menu: { markers: Ob('normal'), highlightOnOpen: l }, data: o, type: 'horizontal' },
        ...
        fB = (e, t, o) => {
            const n = Do().deviceType.isTouch,
                ...
                i = (t) => {
                    if (
                        (ZD(e) && t.preventDefault(),
                        ((e, t) => t.ctrlKey && !ZD(e))(e, t) || ((e) => 0 === eB(e).length)(e))
                    )
                        return
                    const a = ((e, t) => {
                        const o = QD(e),
    ...
    const LB = [
        ...
        PB = (e) => {
            ...
            t.isSome() && o.isSome() && n.isSome()
                ? A.some(
                      ((e, t, o) => ('fixed' === o ? EB : _B)(parseInt(e, 10), parseInt(t, 10)))(
                          t.getOrDie(),
                          o.getOrDie(),
                          n.getOrDie()
                      )
        ...
        sF = (e) =>
            Uh(
                Ph.sketch({
                    ...
                    buttonBehaviours: kl([
                        oF.config({ mode: 'mouseOrTouch', blockerClass: 'blocker', snaps: e }),
                        SS.config({}),
                    ]),
                    eventOrder: {
                                        ...
                                        requestAnimationFrame(() => {
                                            if (null != e.getContainer()) {
                                                const r = Bw(e, t.element)
                                                    ...
                                                    .getOr([])
                                                N(r, (e) => Ze(e, o.target)) &&
                                                    (e.dispatch('ElementScroll', { target: o.target.dom }), n(Es(), o))
                                            }
                                        })
                                    }),
                                    y = () => r(Xd(), {}),
        ...
        AN = (function e() {
            ...
            var Ae = function (e) {
                ...
                Re = function (e) {
                    return 'object' === MR(i)
                        ? e instanceof i
                        : e && 'object' === MR(e) && 'number' == typeof e.nodeType && 'string' == typeof e.nodeName
                },
                Ne = function (e, t, n) {
                    M[e] &&
                        XR(M[e], function (e) {
                    ...
                    return e instanceof l && !Ae(e)
                        ...
                        : ('noscript' !== n && 'noembed' !== n) || !oN(/<\/no(script|embed)/i, e.innerHTML)
                          ? (Y &&
                                ...
                                (t = QR(t, I, ' ')),
                                e.textContent !== t &&
                                    (YR(o.removed, { element: e.cloneNode() }), (e.textContent = t))),
                ...
                ze = function (e, t, o) {
                    ...
                    if (X && !$[t] && oN(R, t));
                        ...
                        if (
                            !(
                                (He(e) &&
                                    ((j.tagNameCheck instanceof RegExp && oN(j.tagNameCheck, e)) ||
                                        (j.tagNameCheck instanceof Function && j.tagNameCheck(e))) &&
                                    ((j.attributeNameCheck instanceof RegExp && oN(j.attributeNameCheck, t)) ||
                                        (j.attributeNameCheck instanceof Function && j.attributeNameCheck(t)))) ||
                                ('is' === t &&
                                    j.allowCustomizedBuiltInElements &&
                                    ((j.tagNameCheck instanceof RegExp && oN(j.tagNameCheck, o)) ||
                ...
                components: [
                    {
                        ...
                        components: [{ dom: ZE(`<p>${MN(t.translate(e))}</p>`) }],
                    },
                ],
            }),
            ...
            return bF.sketch({
                ...
                parts: {
                    blocker: {
                        ...
                        components: [{ dom: { tag: 'div', classes: DN ? [n, n + '--opaque'] : [n] } }],
                    },
                },
                dragBlockClass: o,
                modalBehaviours: kl([
        ...
        GN = (e, t, o, n) =>
            si(
                zN({
                    ...
                    extraBehaviours: [
                        rR.config({ channel: `${CR}-${e.id}`, updateState: (e, t) => A.some(t), initialData: t }),
                        TC({}),
                        ...e.extraBehaviours,
                    ],
                    onEscape: (e) => {
    ...
    const oV = ['insertContent', 'setContent', 'execCommand', 'close', 'block', 'unblock'],
        ...
        rV = (e, t, o, n) => {
            const r = la('dialog'),
                ...
                y = GN(
                    { id: r, header: i, body: l, footer: c, extraClasses: p, extraBehaviours: v, extraStyles: m },
                    e,
                    u,
                    n
                ),
                        ...
                        const c = Xn(qn('data', l, i)),
                                    ...
                                    h = si({
                                        ...
                                        behaviours: kl([
                                            Hp.config({
                                                ...
                                                useTabstopAt: (e) =>
                                                    !VC(e) && ('button' !== Ue(e) || 'disabled' !== Ot(e, 'disabled')),
                                                firstTabstop: 1,
                                            }),
                                            rR.config({
                                                channel: `${CR}-${r}`,
                            ...
                            p = si(
                                Hh.sketch({
                                    ...
                                    isExtraPart: (e, t) =>
                                        ((e) => Iw(e, '.tox-alert-dialog') || Iw(e, '.tox-confirm-dialog'))(t),
                                })
                            )
                        return (
                            d.set(p),
