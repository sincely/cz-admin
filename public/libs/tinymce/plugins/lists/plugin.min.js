        ...
        dt = (e) => (
            S(e, (t, n) => {
                ;((e, t) => {
                    ...
                    (e) => {
                        return (
                            (r = e), ((n = t).listType = r.listType), void (n.listAttributes = { ...r.listAttributes })
                        )
                        var n, r
                    }
                )
                    ...
                    if (ge(r)) {
                        ...
                        r.hasChildNodes()
                            ? ((o = Math.min(o, r.childNodes.length - 1)),
                              n ? r.insertBefore(e, r.childNodes[o]) : St.insertAfter(e, r.childNodes[o]))
                            : r.appendChild(e),
                            (r = e),
                            (o = 0)
                    }
            ...
            const i = (t, n) => {
                ...
                for (; (l = s[i]()); )
                    if (
                        !Oe(e, l) &&
                        !Ct(l.textContent) &&
                        0 !== (null === (o = l.textContent) || void 0 === o ? void 0 : o.length)
                    )
                        return g.some(l)
                return g.none()
            }
